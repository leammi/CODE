...
<body> 
    ...
    <img class="imgcerveau" src="cerveau-nav.png" alt="cerveau" />
        <ul>
            <li><a href="#optique">Effet d'optique</a></li>
            <li><a href="#top_dro">Drogue</a></li>
            <li><a href="#top_mus">Musique</a></li>
    ...
    <section id="top_mus" class="Musique">
        ...
        <img class="imgpartmusique" src="perso logo droite.svg" alt="logo cerveau">
		</div>
    ...
    <section id="top_dro" class="drogue">
        ...
        On peut identifier 3 modes d’actions de ces différentes drogues :</p> 
        <ul>
            ...
            <li>-   Ou elles peuvent bloquer les neuromédiateurs naturels comme l’alcool</li>
        </ul>
        </br>
        <p>
        <p>
    ...
    <section class="effet" data-midnight="white">
        <h2 id="optique">Les effets d'optique</h2>
